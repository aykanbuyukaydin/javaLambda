...
System.out.println("==========");
        //listenin elemmanlarini 2 arrtırarark yazalım
        liste.forEach(t -> System.out.print(t+2 + " "));

        System.out.println("\neger satir sayisi 1 den fazla ise suslu kullanmaliyiz");
        liste.forEach(t -> {
            int miktar = 2;
        ...
        //method referasnsi ===> class adi :: method adi (methodun cagrilmasinin degisik adi)
        System.out.println("\nmethod referans kullanimi");
        liste.forEach(System.out::print); // class adi System.out    method ise print oluyor

        System.out.println("\nmethod referans kullanimi");
        liste.forEach(Lambda01Kurallar::yazdir); // bu sekilde methodumuzu cagrabiliriz
    }
